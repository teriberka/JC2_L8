...
public class ClientHandler {
    ...
    public ClientHandler(Server server, Socket socket) {
        ...
        try {
            ...
            new Thread(() -> {
                try {
                    //Если в течении 2 минут нет авторизации клиента то вызываем исключение
                ...
                // Ловим экспешен СокетТаймаутЭкспешен и принудительно отключаем клиентский сокет с истекшим таймаутом
                } catch (SocketTimeoutException error) {
                    System.out.println("Принудительное отключение клиента!");
                    try {
                        socket.close();
                    } catch (IOException e) {
                        e.printStackTrace();
